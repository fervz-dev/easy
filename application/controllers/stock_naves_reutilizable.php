...
class Stock_naves_reutilizable extends CI_Controller {
public function __construct()
{
	...
	public function index()
	{
        ...
        $data['vista']='stock_naves/stock_reutilizable';
		$data['titulo']='Stock';
    ...
    // Se hace una consulta para saber cuantos registros se van a mostrar
     ...
     $count = $consul->num_rows();
        ...
        if ($start < 0) $start = 0;
        $resultado_catalogo =$this->naves->get_cat_mprima($sidx, $sord, $start, $limite,$oficina);
...
$filters = $_POST['filters'];
        ...
        if (isset($filters)) {
            ...
            $where = " where cprima.activo= '1' AND cprima.id_sucursal =".$oficina." AND ";
            $whereArray = array();
            $rules = $filters->rules;
            ...
            if (count($whereArray)>0) {
                ...
                $where = " where cprima.activo= '1' AND cprima.id_sucursal =".$oficina." ";
            }
        }
...
//    $conexion = new mysqli("servidor","usuario","password","basededatos");
    // Se hace una consulta para saber cuantos registros se van a mostrar
 $consul = $this->db->query('SELECT * FROM cat_mprima_reutilizable AS cprima, resistencia_mprima AS resistencia '.$where);
 $count = $consul->num_rows();
