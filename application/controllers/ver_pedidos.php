...
class Ver_pedidos extends CI_Controller {
 ...
 public function paginacionVer($oficina_id_oficina)
    ...
    $oficina=$oficina_id_oficina;
     ...
     $count = $consul->num_rows();
        ...
        $resultado_ =$this->pedidos_producto->get_pedido_hacer1($oficina, $sidx, $sord, $start, $limite);
...
if ($this->permisos->permisos(21,2)==1) {
    ...
    ///////////////////////////////////////////////////////////////////Sub paginacion ///////////////////////////////////////////////////////////////////////////////////
public function subpaginacionVer($id)
{
...
/* End of file ver_pedidos.php */
/* Location: ./application/controllers/ver_pedidos.php */
