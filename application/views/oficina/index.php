...
function cargar () {
  $("#tbl_oficina").jqGrid({
    ...
    colModel:[{name:'acciones', index:'acciones', width:60, resizable:true, align:"center", search:false},
              ...
              {name:'nombre', index:'nombre', width:90,resizable:true, sortable:true,search:true,editable:true},
              ...
              {name:'coordx', index:'coordx', width:90,resizable:true, sortable:true,search:false,editable:true},
              {name:'coordy', index:'coordy', width:90,resizable:true, sortable:true,search:false,editable:true}
