    ...
    mtype: 'POST',
                        colNames:['Acciones',
                                ...
                                colModel:[{name:'acciones', index:'acciones', width:60, resizable:true, align:"center", search:false},
                                  {name:'nombre_empresa', index:'nombre_empresa', width:150,resizable:true, sortable:true,search:false,editable:false},
                                  {name:'nombre_contacto', index:'nombre_contacto', width:130,resizable:true, sortable:true,search:false,editable:false},
                                  {name:'tipo_persona', index:'tipo_persona', width:100,resizable:true, sortable:true,search:false,editable:false},
                                  {name:'rfc', index:'rfc', width:90,resizable:true, sortable:true,search:false,editable:false},
                                  ...
                                  {name:'ext', index:'ext', width:25,resizable:true, sortable:true,search:false,editable:true},
                                  {name:'fax', index:'fax', width:70,resizable:true, sortable:true,search:false,editable:true},
  ...
  $("#tbl_clientes").jqGrid({
    ...
    mtype: 'POST',
                        ...
                        colModel:[{name:'acciones', index:'acciones', width:60, resizable:true, align:"center", search:false},
                                  ...
                                  {name:'nombre_contacto', index:'nombre_contacto', width:130,resizable:true, sortable:true,search:false,editable:false},
                                  {name:'tipo_persona', index:'tipo_persona', width:100,resizable:true, sortable:true,search:false,editable:false},
                                  {name:'rfc', index:'rfc', width:100,resizable:true, sortable:true,search:false,editable:false},
                                  {name:'estado', index:'estado', width:100,resizable:true, sortable:true,search:false,editable:false},
                                  {name:'municipio', index:'municipio', width:80,resizable:true, sortable:true,search:false,editable:false},
                                  {name:'localidad', index:'localidad', width:80,resizable:true, sortable:true,search:false,editable:false},
                                  {name:'direccion', index:'direccion', width:90,resizable:true, sortable:true,search:false,editable:true},
                                  {name:'cp', index:'cp', width:40,resizable:true, sortable:true,search:false,editable:true},
                                  {name:'lada', index:'lada', width:35,resizable:true, sortable:true,search:false,editable:true},
                                  {name:'num_telefono', index:'num_telefono', width:60,resizable:true, sortable:true,search:false,editable:true},
                                  {name:'ext', index:'ext', width:25,resizable:true, sortable:true,search:false,editable:true},
                                  {name:'fax', index:'fax', width:60,resizable:true, sortable:true,search:false,editable:true},
                                  {name:'email', index:'email', width:180,resizable:true, sortable:true,search:false,editable:true},
                                  {name:'comentario', index:'comentario', width:90,resizable:true, sortable:true,search:false,editable:true},
                                  {name:'fecha_ingreso', index:'fecha_ingreso', width:90,resizable:true, sortable:true,search:false,editable:true}
                                ],
