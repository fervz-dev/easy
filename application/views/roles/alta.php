        ...
        <div id="respuesta_permisos">
          <table width="100%" border="0" cellspacing="0" cellpadding="4">
                        <tr >
                          ...
                          <td width="18%" align="center" bgcolor="#87b6d9" class="subtexto15">Alta (o activar) </td>
                          <td width="13%" align="center" bgcolor="#87b6d9" class="subtexto15">Modificar</td>
                          <td width="13%" align="center" bgcolor="#87b6d9" class="subtexto15">Consultar</td>
                          <td width="13%" align="center" bgcolor="#87b6d9" class="subtexto15">Eliminar</td>
                        </tr>
                </table>        
        ...
        <?php for ($i=0; $i <count($pantallas) ; $i++) { ?>
           ...
           <?php if ($menu[$d]['id_menu']==$pantallas[$i]['id_menu']) {?>                        
                        <tr  >
                          ...
                          <td id="permisos_" width="10%"  align="center" bgcolor="#FFFFFF"><input type="checkbox" name="pantalla<? echo $pantallas[$i]['id_pantalla'].":3";?>" value="1"></td>
                          <td id="permisos_" width="10%" align="center" bgcolor="#FFFFFF"><input type="checkbox" name="pantalla<? echo $pantallas[$i]['id_pantalla'].":4";?>" value="1"></td>
                        </tr>
                        <?php } ?>
