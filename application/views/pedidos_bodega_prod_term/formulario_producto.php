   ...
   datatype: "json",
    mtype: 'POST',
                        ...
                        colModel:[{name:'acciones', index:'acciones', width:60, resizable:false, align:"center", search:false},
                              {name:'nombre', index:'nombre', width:120,resizable:false, sortable:true,search:false,editable:false},
                              ...
                              {name:'resistencia', index:'resistencia', width:50,resizable:false, sortable:true,search:false,editable:false},
                              {name:'corrugado', index:'corrugado', width:60,resizable:false, sortable:true,search:false,editable:false},
