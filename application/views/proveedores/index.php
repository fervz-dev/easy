  ...
  $("#tbl_proveedores").jqGrid({
    ...
    colNames:['Acciones',
     ...
     colModel:[{name:'acciones', index:'acciones', width:60, resizable:true, align:"center", search:false},
              {name:'nombre_contacto', index:'nombre_contacto', width:80,resizable:true, sortable:true,search:false,editable:true},
              {name:'nombre_empresa', index:'nombre_empresa', width:100,resizable:true, sortable:true,search:false,editable:true},
              {name:'estado', index:'estado', width:100,resizable:true, sortable:true,search:false,editable:true},
              {name:'municipio', index:'municipio', width:100,resizable:true, sortable:true,search:false,editable:true},
              {name:'localidad', index:'localidad', width:100,resizable:true, sortable:true,search:false,editable:true},
              {name:'cp', index:'cp', width:60,resizable:true, sortable:true,search:false,editable:true},
              {name:'direccion', index:'direccion', width:90,resizable:true, sortable:true,search:false,editable:true},
              {name:'lada', index:'lada', width:80,resizable:true, sortable:true,search:false,editable:true},
              {name:'num_telefono', index:'num_telefono', width:120,resizable:true, sortable:true,search:false,editable:true},
              {name:'ext', index:'ext', width:170,resizable:true, sortable:true,search:false,editable:true},
              {name:'fax', index:'fax', width:80,resizable:true, sortable:true,search:false,editable:true},
              {name:'email', index:'email', width:40,resizable:true, sortable:true,search:false,editable:true},
...
<div onclick="alta()" id="alta"><img src="<?php '.base_url().' ?>img/nuevo.ico" width="30" height="30" title="Nuevo Registro"></div>
    <?php  }?>
</td>
<td >&nbsp;</td>
</tr>
